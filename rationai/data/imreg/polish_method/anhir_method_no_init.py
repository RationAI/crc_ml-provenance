...
import polish_method.preprocessing as pp
import polish_method.initial_alignment as ia
import polish_method.fail_detector as fd
import polish_method.nonrigid_registration as nr
import polish_method.utils as utils
...
def anhir_method(source, target, echo=True):
    ...
    initial_resample_ratio = utils.calculate_resample_size(source, target, max(params["initial_alignment_size"],
    ...
    if echo:
        print("Nonrigid polish_method start.")
        print()
    ...
    if echo:
        print()
        print("Elapsed time for nonrigid polish_method: ", e_nr_time - b_nr_time, " seconds.")
        print("Nonrigid polish_method end.")
        print()
    ...
    if echo:
        print("Total polish_method time: ", e_time_total - b_time_total, " seconds.")
        print("End of polish_method.")
        print()
