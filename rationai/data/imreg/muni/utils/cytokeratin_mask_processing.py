...
def create_cytokeratin_mask(stain, mask_min_area, holes_min_area):
    """
...
def hole_mask(mask, holes_max_area):
    """
    :param mask: ndarray
        Binary mask.
    :return: ndarray
...
def fill_holes(mask, hematoxylin_mask, holes_max_area, holes_min_area):
    """
    ...
    hole_m = hole_mask(mask, holes_max_area)
...
def mask_remove_he_background(cytokeratin_mask, he_image, mask_min_area, bg_thresh=195):
    """
